<?php /* Smarty version 2.6.18, created on 2013-10-16 17:36:46
...
?>
      ...
      <?php if ($this->_tpl_vars['isUpgrade']): ?>
        <div class="market-info">
          <h3><?php echo OA_Admin_Template::_function_t(array('str' => 'MarketIntroLongTitle'), $this);?>
</h3>
          <p><?php echo OA_Admin_Template::_function_t(array('str' => 'MarketIntroLong'), $this);?>
</p>
          <img class="welcome" src="<?php echo $this->_tpl_vars['assetPath']; ?>
/images/market-auction.gif" alt="Market Auction Example">
        </div>
      
        <p><?php echo OA_Admin_Template::_function_t(array('str' => 'UpgradeContinueToLogin'), $this);?>
</p>
      <?php else: ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'tracker.html', 'smarty_include_vars' => array('step' => 'finish')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>