...
RUN apt-get install -y nginx-full git postgresql-9.2 postgresql-client-9.2 postgresql-contrib-9.2 php5-fpm php-apc php5-imagick php5-imap php5-mcrypt php5-pgsql lynx vim wget curl sudo openssh-server zsh
